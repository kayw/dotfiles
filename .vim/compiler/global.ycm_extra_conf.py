...
# https://github.com/scheib/chromium/commit/8d6edba93eabb17429944ab6ea0bf302daf1c9ff
def SystemIncludeHeaderFlags():
...
def FlagsForFile(filename, **kwargs):
    ...
    final_flags = final_flags + SystemIncludeHeaderFlags()
