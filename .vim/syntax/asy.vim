...
syn keyword     asyExternal     access from import include input
...
syn keyword     asyType         picture csv
...
if exists("asy_syn_plain")
  syn keyword	asyConstant	currentpicture currentpen currentprojection line
